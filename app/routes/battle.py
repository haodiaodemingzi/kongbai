...
@battle_bp.route('/api/rankings', methods=['GET'])
@token_required
...
@battle_bp.route('/api/player/<string:player_name>', methods=['GET'])
@token_required
...
@battle_bp.route('/api/upload', methods=['POST'])
@token_required
...
@battle_bp.route('/api/faction_stats', methods=['GET'])
@token_required
